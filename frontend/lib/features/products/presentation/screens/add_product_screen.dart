...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Future<void> _saveProduct() async {
    ...
    if (mounted) {
      ...
      if (success) {
        // Form submitted correctly, dismiss screen
        Navigator.pop(context);
      } else {
        // Show an error banner
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Failed to save product'), backgroundColor: AppColors.error),
        );
      }
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(hintText: 'e.g. Organic Red Apples'),
                  ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                const Text('Current units available',
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'Add details about product size, weight, or benefits...',
                    ),
                  ),
                ],
              ),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0xFFF8FAFC),
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: Colors.grey.shade200, width: 2, strokeAlign: BorderSide.strokeAlignCenter),
          ),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.add_a_photo, size: 36, color: AppColors.textLight.withValues(alpha: 0.6)),
            ],
          ),
        ),
        const SizedBox(width: 16),
            ...
            children: [
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: const Text('Take Photo', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
