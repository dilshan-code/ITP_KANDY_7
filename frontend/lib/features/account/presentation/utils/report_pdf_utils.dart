        ...
        build: (pw.Context context) {
          return [
            ...
            pw.GridView(
              ...
              children: [
                _buildSummaryStat('Today\'s Sales', currencyFormat.format(summary['todaysSales'] ?? 0)),
                ...
                _buildSummaryStat('Avg Order', currencyFormat.format(summary['averageOrderValue'] ?? 0)),
                _buildSummaryStat('Customer Credit', currencyFormat.format(summary['totalCreditOutstanding'] ?? 0)),
