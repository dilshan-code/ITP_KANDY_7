...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void initState() {
    ...
    _shopNameController.addListener(_clearAuthError);
  ...
  void dispose() {
    ...
    _shopNameController.removeListener(_clearAuthError);
                ...
                children: [
                  ...
                  Consumer<AuthProvider>(
                    builder: (context, auth, _) {
                      if (auth.error != null) {
                        final isDuplicateAccount = auth.error!
                            .toLowerCase()
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (isDuplicateAccount) ...[
                                  const SizedBox(height: 8),
                                  const Text(
                                    'This account is already registered. You can log in now, or remove the email and register with phone only since email is optional.',
                                    style: TextStyle(
                                      color: AppColors.textMedium,
                                      fontSize: 12,
                                    ),
