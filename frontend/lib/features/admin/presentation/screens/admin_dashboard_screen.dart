...
import 'package:frontend/features/admin/presentation/utils/admin_report_pdf_utils.dart';
...
class AdminDashboardScreen extends StatelessWidget {
      ...
      children: [
        Row(
          ...
          children: [
            ...
            FilledButton.icon(
              onPressed: provider.owners.isEmpty
                  ? null
                  : () => AdminReportPdfUtils.exportOwnerRegistrationReport(
                        provider.owners,
                      ),
  ...
  Widget _buildRecentActivity(AdminProvider provider) {
    ...
    owners.sort((a, b) => b.createdAt.compareTo(a.createdAt));
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: _statusColor(owner).withValues(alpha: 0.12),
              borderRadius: BorderRadius.circular(999),
            ),
            child: Text(
              _statusLabel(owner),
              style: TextStyle(
                color: _statusColor(owner),
                fontSize: 11,
